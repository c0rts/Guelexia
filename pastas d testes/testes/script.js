...
const palavra_esq = document.querySelectorAll('.left-list .word');
const palavra_dir = document.querySelectorAll('.right-list .word');
...
function Selecionaplvr(){
    console.log(palavra_esq);
    palavra_esq.dataset.word = 'estrela';
}
